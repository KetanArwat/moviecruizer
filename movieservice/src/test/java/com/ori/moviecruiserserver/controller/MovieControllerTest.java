...
public class MovieControllerTest {
	...
	public void setUp() {
		...
		movie = new Movie(1, "superman", "good movie", "www.abc.com", "2015-03-23", "John123");
		movies.add(movie);
		movie = new Movie(1, "superman", "good movie", "www.abc.com", "2015-03-23", "John123");
		movies.add(movie);
	}
	...
	public void testSaveNewMovieSuccess() throws Exception {
		...
		mvc.perform(post("/api/movie").header("authorization", "Bearer " + token).
	...
	public void testGetMyMovies() throws Exception {
		...
		mvc.perform(get("/api/movie").header("authorization", "Bearer " + token)
